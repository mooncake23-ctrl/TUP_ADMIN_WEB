...
class _ViolationsScreenState extends State<ViolationsScreen> with TickerProviderStateMixin {
  List violations = [];
  bool isLoading = true;
  ...
  Future<void> deleteViolation(String name, String status) async {
    try {
      final response = await http.post(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      labelText: "Email",
                      labelStyle: TextStyle(color: Colors.black87), // Dark label color
                    ...
                    style: TextStyle(color: Colors.black87), // Dark input text color
                  ),
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    items: ['low', 'medium', 'high']
                      ...
                      child: Text(
                        ...
                        style: TextStyle(color: Colors.black54), // Lighter text color for dropdown items
                      ),
                    ))
                        .toList(),
                    onChanged: (value) {
                    ...
                    decoration: InputDecoration(
                      labelText: "Severity",
                      labelStyle: TextStyle(color: Colors.black), // Lighter label color
                      border: OutlineInputBorder(borderRadius: BorderRadius.circular(8)),
                      filled: true,
                      fillColor: Colors.grey[100], // Lighter fill color
                    ),
                    style: TextStyle(color: Colors.black), // Lighter text color for the selected value
                    dropdownColor: Colors.white, // Lighter background color for dropdown
                    selectedItemBuilder: (BuildContext context) {
                      return ['low', 'medium', 'high'].map<Widget>((String item) {
                        return Text(
                          item[0].toUpperCase() + item.substring(1),
                          style: TextStyle(color: Colors.black), // Lighter color for selected item
                        );
                      }).toList();
                    },
                  ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () => deleteViolation(
                              violation['name'], 'resolved'),
                          child: Text(
                            'Resolve',
